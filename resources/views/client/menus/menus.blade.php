                ...
                @foreach($categories as $categoryName => $items)
                    <div class="category-section">
                        <h3 class="category-title">
                            @switch($categoryName)
                                @case('Entrées') <i class="fas fa-leaf"></i> @break
                                @case('Plats principaux') <i class="fas fa-utensils"></i> @break
                                @case('Desserts') <i class="fas fa-ice-cream"></i> @break
                                @case('Boissons') <i class="fas fa-glass-whiskey"></i> @break
                        ...
                        <ul class="dish-list">
                            @forelse($items as $item)
                                <li class="dish-item" data-id="{{ $item->id }}" data-name="{{ $item->name }}" data-price="{{ $item->price }}">
                                    <div class="dish-left">
                                        @if($item->image)
                                    ...
                                    <div class="dish-right">
                                        <span class="dish-price">{{ number_format($item->price, 2) }} DH</span>
...
<div class="cart-container">
    ...
    <div class="cart-panel">
        ...
        <div class="cart-actions">
            ...
            <form action="{{ route('storeCmd') }}" method="POST" id="commande-form">
                @csrf
