    ...
    <div class="container-fluid">
        <a class="navbar-brand d-flex align-items-center gap-2" href="<?php echo e(route('home')); ?>">
            <?php if($settings && $settings->logo_path): ?>
                <img src="<?php echo e(asset('storage/' . $settings->logo_path)); ?>" alt="Logo" style="height: 50px; border-radius: 5px;">
            <?php endif; ?>
...
<?php /**PATH C:\Users\pc\Downloads\snack_app_rupture_stock\snack_app\resources\views/components/nav-manager.blade.php ENDPATH**/ ?>