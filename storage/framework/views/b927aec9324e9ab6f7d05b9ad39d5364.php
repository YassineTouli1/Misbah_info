...
<div class="client-container">
    ...
    <section class="welcome-section">
        <div class="welcome-content">
            ...
            <a href="<?php echo e(route('client.menus')); ?>" class="btn-orange">
                ...
                <table class="orders-table">
                    ...
                    <?php $__currentLoopData = $commandes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commande): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($commande->created_at->format('d/m/Y H:i')); ?></td>
                            <td>
                                <?php if($commande->menuItems->count() > 0): ?>
                                    <ul class="list-unstyled" style="margin:0;padding:0;">
                                        <?php $__currentLoopData = $commande->menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li>
                                                <?php echo e($item->pivot->quantity); ?>x <?php echo e($item->name ?? $item->nom); ?>

                                                <small style="color:#888;">(<?php echo e(number_format($item->pivot->price, 2)); ?> DH)</small>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                <?php else: ?>
                            ...
                            <td><strong><?php echo e(number_format($commande->total, 2)); ?> DH</strong></td>
                            <td>
                                <span class="status-badge status-<?php echo e($commande->statut); ?>">
                                    <?php if($commande->statut === 'livree' && $commande->validee_par_client): ?>
                                    ...
                                    <?php else: ?>
                                        <?php switch($commande->statut):
                                            ...
                                            <?php case ('confirmee'): ?> Confirmée <?php break; ?>
                                            <?php case ('en_preparation'): ?> En préparation <?php break; ?>
                                            <?php case ('prete'): ?> Prête <?php break; ?>
                                            <?php case ('livree'): ?> <span class="badge" style="background:#cfe2ff; color:#084298;">Livrée</span> <?php break; ?>
                                            <?php case ('annulee'): ?> <span class="badge badge-danger" style="background:#f8d7da; color:#842029;">Annulée</span> <?php break; ?>
                                            <?php case ('retournee'): ?> <span class="badge badge-danger" style="background:#f8d7da; color:#842029;">Retournée</span> <?php break; ?>
                                            <?php default: ?> <?php echo e($commande->statut); ?>
...
<?php /**PATH C:\Users\pc\Downloads\snack_app_rupture_stock\snack_app\resources\views/client/home.blade.php ENDPATH**/ ?>