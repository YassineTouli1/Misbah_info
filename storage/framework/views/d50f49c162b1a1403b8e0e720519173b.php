...
<?php endif; ?>
    ...
    <main class="main-content">
        ...
        <section class="add-client-form-section">
            <form action="<?php echo e(route('stock.store')); ?>" method="POST" class="form-style" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\pc\Downloads\snack_app_rupture_stock\snack_app\resources\views/dashboard/ingredient/addingredient.blade.php ENDPATH**/ ?>